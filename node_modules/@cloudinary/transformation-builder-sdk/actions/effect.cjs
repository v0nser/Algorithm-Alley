...
var actions_effect_GenerativeRemove = require('./effect/GenerativeRemove.cjs');
var actions_effect_GenerativeReplace = require('./effect/GenerativeReplace.cjs');
...
function generativeRemove() {
    return new actions_effect_GenerativeRemove.GenerativeRemove();
}
/**
 * @summary action
...
function generativeReplace() {
    return new actions_effect_GenerativeReplace.GenerativeReplace();
}
/**
 *
